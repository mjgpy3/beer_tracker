...
class BeersControllerTest < ActionController::TestCase
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post :create, beer: { bottle: @beer.bottle, brew: @beer.brew, brewery: @beer.brewery, can: @beer.can, picture: @beer.picture }
    end
  ...
  test "should update beer" do
    put :update, id: @beer, beer: { bottle: @beer.bottle, brew: @beer.brew, brewery: @beer.brewery, can: @beer.can, picture: @beer.picture }
    assert_redirected_to beer_path(assigns(:beer))
  end
